...
public enum SessionRestore {
    ...
    public enum LaunchMode: String, Codable {
        case bash
        case agent
    }
    ...
    public struct Entry: Codable {
        ...
        public let cbcSessionID: String?
    ...
    public static func save(sessionID: String, projectDir: String, cbcSessionID: String?, agentType: AgentType = .codebuddy, launchMode: LaunchMode = .bash) {
        ioQueue.async {
    ...
    public static func loadAll() -> [Entry] {
        return ioQueue.sync {
    ...
    public static func acceptClaudeTrust(directory: String) {
