...
func DefaultDBPath() string {
	...
	return filepath.Join(home, ".cbsm", "sessions.db")
}
...
func (s *Store) Save(sess *Session) error {
	...
	query := `
	INSERT INTO sessions (id, name, project_dir, cbc_session_id, tmux_session,
		tmux_window, status, ai_title, git_branch, pid, created_at, updated_at)
	VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
...
func (s *Store) Get(id string) (*Session, error) {
	query := `SELECT id, name, project_dir, cbc_session_id, tmux_session,
		tmux_window, status, ai_title, git_branch, pid, created_at, updated_at
